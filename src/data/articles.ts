...
export const articles: Article[] = [
  {
    id: 1,
    title: 'قمة عربية تاريخية تناقش التحديات الإقليمية والتعاون الاقتصادي',
    excerpt: 'اجتمع القادة العرب في قمة استثنائية لمناقشة أهم القضايا الإقليمية وسبل تعزيز التعاون الاقتصادي والسياسي',
...
كما تم الإعلان عن عدة مبادرات جديدة تهدف إلى تعزيز التكامل الاقتصادي بين الدول العربية وتحقيق التنمية المستدامة.`,
    image: 'https://images.unsplash.com/photo-1672762232115-0b8b1adb8509?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaWRkbGUlMjBlYXN0JTIwbmV3c3xlbnwxfHx8fDE3NjEyMzY2Nzd8MA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  {
    id: 2,
    title: 'صندوق النقد الدولي يتوقع نموًا اقتصاديًا قويًا في الشرق الأوسط',
    excerpt: 'أشار تقرير حديث إلى أن اقتصادات المنطقة تشهد تعافيًا ملحوظًا مع توقعات بنمو يتجاوز 4% هذا العام',
...
وحذر الخبراء من بعض التحديات التي قد تواجه المنطقة، بما في ذلك التقلبات في أسعار النفط والتوترات الجيوسياسية.`,
    image: 'https://images.unsplash.com/photo-1709715357520-5e1047a2b691?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMG1lZXRpbmd8ZW58MXx8fHwxNzYxMjA0NTE5fDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'اقتصاد',
  ...
  {
    id: 3,
    title: 'المنتخب الوطني يحقق فوزًا تاريخيًا في التصفيات الآسيوية',
    excerpt: 'تغلب المنتخب على منافسه بنتيجة 3-1 في مباراة مثيرة ضمن تصفيات كأس العالم',
...
وعلق المشجعون على وسائل التواصل الاجتماعي بحماس كبير، معبرين عن فخرهم بإنجاز المنتخب.`,
    image: 'https://images.unsplash.com/photo-1668068873075-cf3e9925eae4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb2NjZXIlMjBmb290YmFsbHxlbnwxfHx8fDE3NjEyMzY2Nzh8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'رياضة',
    categorySlug: 'sports',
    date: 'منذ ساعة',
    author: 'عمر السعيد',
  ...
  {
    id: 4,
    title: 'شركة تقنية عربية تطلق تطبيقًا ذكيًا يستخدم الذكاء الاصطناعي',
    excerpt: 'التطبيق الجديد يقدم حلولاً مبتكرة في مجال الخدمات الرقمية باستخدام أحدث تقنيات الذكاء الاصطناعي',
...
وقد لقي الإطلاق استحسانًا كبيرًا من قبل الخبراء التقنيين، الذين أشادوا بالإمكانيات الواعدة للتطبيق.`,
    image: 'https://images.unsplash.com/photo-1568952433726-3896e3881c65?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWNobm9sb2d5JTIwaW5ub3ZhdGlvbnxlbnwxfHx8fDE3NjEyMzQ5MjN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'تكنولوجيا',
  ...
  {
    id: 5,
    title: 'تحليل: التحولات الاقتصادية في المنطقة وتأثيرها على المستقبل',
    excerpt: 'قراءة معمقة في التطورات الاقتصادية الأخيرة وما تحمله من فرص وتحديات للمنطقة العربية',
...
ومع ذلك، تبقى هناك تحديات يجب معالجتها، بما في ذلك البطالة وتطوير المهارات وجذب الاستثمارات الأجنبية.`,
    image: 'https://images.unsplash.com/photo-1738739905706-2cc26e57f67d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxuZXdzJTIwYW5hbHlzaXN8ZW58MXx8fHwxNzYxMjQ2NjgyfDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'تحليلات',
  ...
  },
  {
    ...
    excerpt: 'المهرجان يستضيف عروضًا أولى لأعمال سينمائية عربية حصدت إشادات واسعة من النقاد',
...
وقد شهدت العروض إقبالًا كبيرًا من الجمهور والنقاد، الذين أشادوا بجودة الأعمال المعروضة.`,
    image: 'https://images.unsplash.com/photo-1760582912320-79fcbc9f309b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2YXJpZXR5JTIwZW50ZXJ0YWlubWVudHxlbnwxfHx8fDE3NjEyNDY2ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'منوعات',
  ...
  },
  {
    ...
    excerpt: 'كيف يمكن للأنظمة التعليمية العربية الاستفادة من التقنيات الحديثة لتطوير جودة التعليم',
...
إن الاستثمار في تدريب المعلمين على استخدام التقنيات الحديثة هو المفتاح لنجاح أي تحول رقمي في التعليم.`,
    image: 'https://images.unsplash.com/photo-1759593047650-60328e9356ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvcGluaW9uJTIwZGlzY3Vzc2lvbnxlbnwxfHx8fDE3NjEyNDY2ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'آراء',
  ...
  },
  {
    ...
    excerpt: 'تقرير مصور يستعرض أبرز الابتكارات التقنية المعروضة في المعرض السنوي',
...
ويمكن مشاهدة التقرير المصور الكامل عبر موقعنا الإلكتروني، حيث نستعرض أبرز الابتكارات بالتفصيل.`,
    image: 'https://images.unsplash.com/photo-1497015289639-54688650d173?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2aWRlbyUyMHByb2R1Y3Rpb258ZW58MXx8fHwxNzYxMjQwNjc5fDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'فيديو',
    categorySlug: 'video',
    date: 'منذ 8 ساعات',
    author: 'فريق التحرير',
  ...
  },
  {
    ...
    excerpt: 'توقيع اتفاقية شاملة تهدف إلى تعزيز التعاون الاقتصادي والأمني بين دول المجلس',
...
وتوقع المحللون أن تكون لهذه الاتفاقية آثار إيجابية على اقتصادات دول المنطقة.`,
  ...
  },
  {
    ...
    excerpt: 'زعماء العالم يجتمعون لمناقشة التغير المناخي واتخاذ إجراءات عاجلة',
    image: 'https://images.unsplash.com/photo-1596339502177-8de71f7cacfd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b3JsZCUyMG5ld3MlMjBpbnRlcm5hdGlvbmFsfGVufDF8fHx8MTc2MTIyNjc0Mnww&ixlib=rb-4.1.0&q=80&w=1080',
...
وأشاد الخبراء بالتقدم الذي تم إحرازه في المفاوضات.`,
  ...
  {
    id: 11,
    title: 'الدولي: اتفاق تجاري جديد بين القوى الاقتصادية الكبرى',
    excerpt: 'توقيع اتفاقية تجارية تاريخية تهدف إلى تعزيز التبادل التجاري العالمي',
    image: 'https://images.unsplash.com/photo-1600633349333-eebb43d01e23?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnRlcm5hdGlvbmFsJTIwcG9saXRpY3N8ZW58MXx8fHwxNzYxMjQ3ODQxfDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'الدولي',
...
وأشاد الاقتصاديون بهذه الخطوة ووصفوها بأنها تاريخية.`,
  ...
  },
  {
    ...
    excerpt: 'باحثون يحددون العوامل الرئيسية التي تساهم في العيش حياة أطول وأكثر صحة',
    image: 'https://images.unsplash.com/photo-1535914254981-b5012eebbd15?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGglMjB3ZWxsbmVzc3xlbnwxfHx8fDE3NjExNTkwNDJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'صحة',
    categorySlug: 'health',
...
ونصح الخبراء بضرورة الابتعاد عن التدخين وتجنب التوتر المفرط.`,
  ...
  },
  {
    ...
    excerpt: 'افتتاح معرض استثنائي يعرض روائع الفن الإسلامي عبر العصور',
    image: 'https://images.unsplash.com/photo-1621760681857-215258afbbee?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjdWx0dXJlJTIwYXJ0fGVufDF8fHx8MTc2MTI0NzYxNHww&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'ثقافة',
...
وقد شهد المعرض إقبالاً كبيراً منذ افتتاحه قبل أسبوع.`,
  ...
  },
  {
    ...
    excerpt: 'انتصار كبير للمنتخب الوطني يضمن التأهل لنهائيات البطولة القارية',
    image: 'https://images.unsplash.com/photo-1693683223438-7da7c75edd91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcG9ydHMlMjBmb290YmFsbHxlbnwxfHx8fDE3NjEzNzAwMjd8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'رياضة',
    categorySlug: 'sports',
...
ويستعد الفريق الآن لمواجهة أصعب في المراحل المقبلة.`,
  ...
  {
    id: 15,
    title: 'اقتصاد: ارتفاع مؤشرات البورصة وتحسن أداء الأسواق المحلية',
    excerpt: 'تسجل الأسواق المالية ارتفاعًا ملحوظًا في التداولات اليومية',
    image: 'https://images.unsplash.com/photo-1560789299-12a60c2b7baa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGVjb25vbXl8ZW58MXx8fHwxNzYxMjkyODk0fDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'اقتصاد',
    categorySlug: 'economy',
...
ويتوقع الخبراء استمرار هذا الأداء الإيجابي خلال الأسابيع المقبلة.`,
  ...
  },
  {
    ...
    excerpt: 'شركة ناشئة تطلق منصة تعليمية تعتمد على الذكاء الاصطناعي',
    image: 'https://images.unsplash.com/photo-1599081595468-de614fc93694?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb24lMjBsZWFybmluZ3xlbnwxfHx8fDE3NjEzNzAwMjh8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'تكنولوجيا',
    categorySlug: 'technology',
...
وقد حصل التطبيق على تمويل كبير من مستثمرين محليين ودوليين.`,
  ...
  },
  {
    ...
    excerpt: 'انطلاق فعاليات مهرجان سنوي يعرض الحرف التقليدية والفنون الشعبية',
    image: 'https://images.unsplash.com/photo-1621760681857-215258afbbee?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjdWx0dXJlJTIwYXJ0fGVufDF8fHx8MTc2MTI0NzYxNHww&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'منوعات',
    categorySlug: 'variety',
...
وشهدت الفعاليات حضوراً جماهيرياً كبيراً منذ اليوم الأول.`,
  ...
  {
    id: 18,
    title: 'آراء: المسؤولية الاجتماعية للشركات في عصر التحول الرقمي',
    excerpt: 'كيف يمكن للشركات الكبرى أن تساهم في التنمية المستدامة',
    image: 'https://images.unsplash.com/photo-1759593047650-60328e9356ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvcGluaW9uJTIwZGlzY3Vzc2lvbnxlbnwxfHx8fDE3NjEyNDY2ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'آراء',
    categorySlug: 'opinions',
...
والحصول على قسط كافٍ من النوم أمر أساسي لتقوية جهاز المناعة.`,
  ...
  {
    id: 20,
    title: 'الشرق الأوسط: مبادرة جديدة لتعزيز السلام في المنطقة',
    excerpt: 'إطلاق مبادرة دبلوماسية تهدف إلى حل النزاعات الإقليمية',
    image: 'https://images.unsplash.com/photo-1672762232115-0b8b1adb8509?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaWRkbGUlMjBlYXN0JTIwbmV3c3xlbnwxfHx8fDE3NjEyMzY2Nzd8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'الشرق الأوسط',
    categorySlug: 'middle-east',
...
ويأمل الجميع أن تؤدي هذه المبادرة إلى استقرار دائم في المنطقة.`,
  ...
  // Additional Middle East articles
  {
    ...
    excerpt: 'خطوات إيجابية نحو تسوية القضايا العالقة بين دول المنطقة',
  ...
  },
  {
    ...
    excerpt: 'مشاريع عملاقة تهدف لتطوير البنية التحتية في دول المنطقة',
  ...
  },
  {
    ...
    excerpt: 'مؤتمر إقليمي يناقش مستقبل الطاقة النظيفة في المنطقة',
  ...
  // Additional Economy articles
  {
    ...
    excerpt: 'القطاع الصناعي يحقق أرقاماً قياسية في الإنتاج والتصدير',
  ...
  },
  {
    ...
    excerpt: 'مبادرة حكومية جديدة لتمكين رواد الأعمال والمشاريع الناشئة',
  ...
  },
  {
    ...
    excerpt: 'تكريم مستحق للاعب بعد موسم استثنائي مليء بالإنجازات',
  ...
  },
  {
    ...
    excerpt: 'إنجاز تقني كبير يضع البلاد على خريطة تكنولوجيا الفضاء',
...
ومع ذلك، تبقى هناك تحديات يجب معالجتها، بما في ذلك البطالة وتطوير المهارات وجذب الاستثمارات الأجنبية.`,
  ...
  },
  {
    ...
    excerpt: 'استراتيجيات لضمان الأمن الغذائي في ظل التغيرات المناخية',
  ...
  // World News Articles
  {
    ...
    excerpt: 'زعماء العالم يتفقون على خفض الانبعاثات الكربونية بنسبة 50% بحلول 2030',
    ...
    image: 'https://images.unsplash.com/photo-1596339502177-8de71f7cacfd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b3JsZCUyMG5ld3MlMjBpbnRlcm5hdGlvbmFsfGVufDF8fHx8MTc2MTQwNDM4OHww&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'أخبار العالم',
    categorySlug: 'world-news',
    date: 'منذ ساعتين',
    author: 'نور الدين',
  ...
  },
  {
    ...
    excerpt: 'مليارا دولار لدعم اللاجئين والمتضررين من الأزمات الإنسانية حول العالم',
    ...
    image: 'https://images.unsplash.com/photo-1744827324103-6aae68abb440?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnbG9iYWwlMjBwb2xpdGljcyUyMHN1bW1pdHxlbnwxfHx8fDE3NjE0MDkwMTh8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'أخبار العالم',
    categorySlug: 'world-news',
    date: 'منذ 4 ساعات',
    author: 'محمد الأحمد',
  ...
  {
    id: 35,
    title: 'الأمم المتحدة تدعو لوقف إطلاق النار في مناطق التوتر',
    excerpt: 'الأمين العام يطالب جميع الأطراف بالعودة إلى طاولة المفاوضات',
    ...
    image: 'https://images.unsplash.com/photo-1731191286461-87a731fc7310?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx1bml0ZWQlMjBuYXRpb25zJTIwbWVldGluZ3xlbnwxfHx8fDE3NjE0MDkwMTl8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'أخبار العالم',
    categorySlug: 'world-news',
    date: 'منذ 5 ساعات',
    author: 'ياسر العتيبي',
  ...
  },
  {
    ...
    excerpt: 'توقيع اتفاق شراكة اقتصادية شاملة يضم 15 دولة في المنطقة',
    ...
    image: 'https://images.unsplash.com/photo-1679145586764-1458de644200?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnRlcm5hdGlvbmFsJTIwZGlwbG9tYWN5fGVufDF8fHx8MTc2MTQwOTAxOXww&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'أخبار العالم',
    categorySlug: 'world-news',
    date: 'منذ 6 ساعات',
    author: 'سارة الكريم',
  ...
  {
    id: 37,
    title: 'رأي: الذكاء الاصطناعي بين الفرص والتحديات الأخلاقية',
    excerpt: 'كيف يمكن تسخير قوة الذكاء الاصطناعي مع الحفاظ على القيم الإنسانية',
    ...
    image: 'https://images.unsplash.com/photo-1598363431659-330370aaaa7b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvcGluaW9uJTIwZWRpdG9yaWFsfGVufDF8fHx8MTc2MTQwOTM3MXww&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'آراء',
    categorySlug: 'opinions',
    date: 'منذ 15 ساعة',
    author: 'د. أحمد السالم',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1723006694466-bebac409aa8d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZWJhdGUlMjBkaXNjdXNzaW9ufGVufDF8fHx8MTc2MTMxMzIxOHww&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'آراء',
    categorySlug: 'opinions',
    date: 'منذ 23 ساعة',
  ...
  {
    id: 39,
    title: 'الدولي: قمة العشرين تناقش الاقتصاد العالمي والتجارة',
    excerpt: 'زعماء أكبر اقتصادات العالم يبحثون سبل تعزيز النمو العالمي',
    ...
    image: 'https://images.unsplash.com/photo-1668120084348-efc2ba0ad31d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnRlcm5hdGlvbmFsJTIwZmxhZ3N8ZW58MXx8fHwxNzYxNDA5MzcyfDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'الدولي',
    categorySlug: 'international',
    date: 'منذ 3 ساعات',
    author: 'محمد الأحمد',
  ...
  },
  {
    ...
    excerpt: 'مطالبات بتحديث القواعد التجارية لمواكبة التحولات العالمية',
    ...
    image: 'https://images.unsplash.com/photo-1521295121783-8a321d551ad2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b3JsZCUyMGdsb2JlfGVufDF8fHx8MTc2MTMxMjkxNHww&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'الدولي',
    categorySlug: 'international',
    date: 'منذ 7 ساعات',
    author: 'سارة الكريم',
  ...
  },
  {
    ...
    excerpt: 'دول العالم تتعهد بتكثيف التعاون الأمني والاستخباراتي',
  ...
  // Additional Variety articles
  {
    ...
    excerpt: 'الفنان العالمي يستعد لتقديم عروض استثنائية في عدة مدن',
    ...
    image: 'https://images.unsplash.com/photo-1760582912320-79fcbc9f309b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2YXJpZXR5JTIwZW50ZXJ0YWlubWVudHxlbnwxfHx8fDE3NjE0MDkzNzJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'منوعات',
    categorySlug: 'variety',
    date: 'منذ 10 ساعات',
    author: 'ليلى حسن',
  ...
  },
  {
    ...
    excerpt: 'علماء آثار يكشفون عن اكتشاف يلقي ضوءاً على حضارة قديمة',
    ...
    image: 'https://images.unsplash.com/photo-1671402116267-3c8f9f4fd917?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsaWZlc3R5bGUlMjBwZW9wbGV8ZW58MXx8fHwxNzYxNDA5MzczfDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'منوعات',
    categorySlug: 'variety',
    date: 'منذ 14 ساعة',
    author: 'د. فاطمة العلي',
  ...
  // Additional Culture article
  {
    ...
    excerpt: 'شعراء من مختلف الدول العربية يتنافسون في مهرجان شعري كبير',
    ...
    image: 'https://images.unsplash.com/photo-1648026141691-96be4a41b687?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjdWx0dXJlJTIwbXVzZXVtfGVufDF8fHx8MTc2MTQwOTM3M3ww&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'ثقافة',
    categorySlug: 'culture',
    date: 'منذ 12 ساعة',
    author: 'ليلى حسن',
